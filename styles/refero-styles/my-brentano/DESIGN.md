...
40px circle, 1px border in #000000, transparent fill, centered right-arrow glyph in Charcoal Ink (#212529). Used for Shop, Blog, Uber uns nav items. Pairs with the language selector.

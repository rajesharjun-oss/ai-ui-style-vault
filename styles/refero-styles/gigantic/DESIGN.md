...
Transparent background, 1px Ink Black (#231f20) border, Ink Black text, 0px radius, 19px horizontal x 15px vertical padding, same type as filled variant. The bordered rectangular form is the brand's workhorse - appears under every product card.

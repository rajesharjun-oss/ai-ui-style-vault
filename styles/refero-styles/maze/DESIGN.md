...
- **Substitute:** GT Sectra Display (for display), Tiempos Text (for body), or Sohne Breit as a sans-serif fallback if a serif is unavailable
- **Weights:** 300, 400
...
- **Substitute:** Inter, Sohne, or system-ui
- **Weights:** 400
- **Sizes:** 16
- **Line height:** 1.50
...
Full-bleed Charcoal (#000000) bar, white Phonic 14px / 400 text, centered, with right-aligned close x. Height ~40px, used for product news or report launches.
...
Ink (#1c1c1c) background, Paper (#ffffff) text, Phonic 15px / 400, 8px radius, 12px vertical x 20px horizontal padding. No shadow, no gradient. The default conversion CTA.

### Outlined Ghost Button
**Role:** Secondary action

Transparent background, 1px Ink (#1c1c1c) border, Ink text, Phonic 15px / 400, 8px radius, 12px x 20px padding. Pairs beside the filled dark button in the hero.
...
Chartreuse (#dbf570) background, Ink text, Phonic 12px / 400, 4px radius, 4px x 8px padding. Marks study type cards.

...
Grid of 5 columns x 3 rows of brand wordmarks on white or mint background. Logos are rendered in muted gray or original brand color, evenly spaced with 30-40px gaps. No card containers - logos float on the canvas to keep the editorial feel.

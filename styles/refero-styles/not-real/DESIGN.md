...
- **Substitute:** Inter, Sohne, or Suisse Int'l
- **Weights:** 400
...
Renders 'NotReal(R)' in ogg at approximately 55px with the registered trademark superscript. The serif letterforms with aggressive negative tracking create a luxury-fashion-house impression. Links to home. No background, no border - pure typographic mark on the Vellum canvas.

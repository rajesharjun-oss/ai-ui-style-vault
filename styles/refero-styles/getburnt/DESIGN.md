...
Background #1a1a17, text #ffffff, 1440px border-radius (full pill), 28px horizontal padding x ~12px vertical, Switzer 15-16px weight 500, 0.03em tracking. Optional trailing arrow icon in white. Anchors the header and hero.
...
Inline pill, ~6px vertical x 10px horizontal padding, 1440px radius, Switzer 12-13px weight 500. Healthy = subtle green-tinted neutral bg + dark text; Critical = warm-tinted neutral bg + dark text. The system deliberately avoids saturated red/green - badges stay within the warm-monochrome palette.

...
- **Substitute:** Inter, Neue Haas Grotesk, Sohne
- **Weights:** 400
- **Sizes:** 16px
- **Line height:** 1.00
...
Full-bleed 'freshman' logotype, set ultra-large in italic Editorial New weight 200, white (#ffffff) fill on Carbon Black (#000000). Letter-spacing -0.01em. A small registered-trademark (R) sits at the upper-right of the mark. No background, no border, no shadow - the wordmark is the only object on screen.

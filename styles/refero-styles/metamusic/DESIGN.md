...
- **Substitute:** Inter, Sohne, or IBM Plex Sans
- **Weights:** 400, 500, 600
...
- **Substitute:** GT America, Druk Wide, or Sohne Breit
- **Weights:** 500
- **Sizes:** 22
- **Line height:** 0.90
...
Background Lavender Mist (#e6e0f8), full-width, padding 8px, Charcoal Ink text at 12-14px, small close x on the right. The only persistent banner in the system.

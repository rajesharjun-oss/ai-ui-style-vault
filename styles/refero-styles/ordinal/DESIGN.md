...
1440px (fully rounded) radius, 11px horizontal x 13px vertical padding, Inter 15px 500. Background #8ef5b5, text #151316. No border, no shadow. Always sits as a single accent against monochrome neighbors - never appears twice on the same view.

### Ghost Outlined Button
**Role:** Secondary action beside a mint CTA

5px radius, 11px x 13px padding, 1px border #ffffff, text #ffffff, background transparent. Inter 15px 500. Pairs with the mint pill in the hero and nav to form a 'primary + secondary' duo without introducing a second color.
...
10px radius square, 64x64px, filled with the platform's own brand color (LinkedIn blue, Twitter sky, Instagram magenta, Facebook blue, YouTube red, Slack purple, etc). Flat, no shadow, arranged in a 2x5 grid on white.

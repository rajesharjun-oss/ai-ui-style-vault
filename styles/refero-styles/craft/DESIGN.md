...
Square button, ~40x40px, 4px radius. Border: 1px #1d3023 or #eae6df depending on nav context. Icon: 3 horizontal dots or lines in #1d3023. Sits at the right end of the floating pill nav.
...
- **Studio Daidai** - Same flat two-tone surface approach without shadows, cream backgrounds, and vivid green used as functional punctuation rather than decoration

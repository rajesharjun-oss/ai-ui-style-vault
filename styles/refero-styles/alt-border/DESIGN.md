...
### Inferi - Multi-purpose face - medium-weight paragraphs (21px), oversized secondary statements (34px, 120px), and small UI labels (14px). The negative tracking (-0.0270em) tightens the rhythm at every size. Substitute: Sohne, Inter, or Untitled Sans. - `--font-inferi`
- **Substitute:** Sohne
- **Weights:** 200-400
- **Sizes:** 14px, 21px, 34px, 120px
- **Line height:** 1.00-2.00
- **Letter spacing:** -0.0270em
- **Role:** Multi-purpose face - medium-weight paragraphs (21px), oversized secondary statements (34px, 120px), and small UI labels (14px). The negative tracking (-0.0270em) tightens the rhythm at every size. Substitute: Sohne, Inter, or Untitled Sans.

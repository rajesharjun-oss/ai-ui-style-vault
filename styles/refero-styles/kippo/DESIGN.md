...
Standard Apple App Store / Google Play badges, white on black. Source Code Pro used for any adjacent helper text. Sized at approximately 120x40px, with no rounding beyond the badge's native corners.

...
Full-bleed horizontal strip, typically cream (#f9f8ea) or seafoam (#a5d3d4), 80-120px tall, containing a single small centered label in Maax Mono (e.g. 'Enter: Lauft bei Ihnen', 'Unsere Partner').

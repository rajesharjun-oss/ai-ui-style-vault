...
- **Substitute:** Sohne, Inter, General Sans
- **Weights:** 500, 600
...
Small landscape image (~140x80px), 8-12px radius, Ink or soft color from the video plate. Sits to the left of the manifesto text, vertically aligned to the active item. Acts as visual ear to the text column.

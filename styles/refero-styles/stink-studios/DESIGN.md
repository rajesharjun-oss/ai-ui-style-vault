...
100vw x 100vh image or video, no overlay, no gradient. Logo sits top-left or top-center in 52px Helvetica 300 white with optional warm gold-to-white gradient on accent characters. Navigation anchors to bottom-right corner at 16px/400 white, 20px gap between links, no background or border.

...
### Basel - Custom brand face used sparingly for select body text passages - a single weight (500) suggests Basel Grotesk or a geometric grotesque chosen for its even, technical character. Substitute: Inter or Sohne at weight 500. - `--font-basel`
- **Substitute:** Inter, Sohne
- **Weights:** 500
- **Sizes:** 16px
- **Line height:** 1.50
- **Role:** Custom brand face used sparingly for select body text passages - a single weight (500) suggests Basel Grotesk or a geometric grotesque chosen for its even, technical character. Substitute: Inter or Sohne at weight 500.

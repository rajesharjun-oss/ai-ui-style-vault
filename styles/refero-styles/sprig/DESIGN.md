...
- **Substitute:** Sohne, GT America, Inter Display
- **Weights:** 400, 500
...
Espresso (#272420) background, Bone (#faf9f8) text, 32px border-radius (full pill), 12px horizontal padding x 6px vertical padding. TT Commons Pro 16px weight 400. Optional 3px arrow icon with 3px gap. No border. The pill shape is non-negotiable - filled buttons are always fully rounded.

### Ghost/Outline Button
**Role:** Secondary actions, nav-adjacent controls, less prominent conversion paths.

Transparent background, 1px border in Vapor (#dddcd9) or Mist (#e8e7e6), text in Abyssal Ink (#0b2330), 32px border-radius (pill), 12px x 6px padding. TT Commons Pro 16px weight 400.

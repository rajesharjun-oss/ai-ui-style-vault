...
Full-width #141414 background, white text. Left: close (x) icon + Peggy app-icon tile in white #f4f4f4 square. Center: 'Download the Peggy App' headline (Inter 14px weight 500, white) with sub-copy 'Install the app and sign in to get started.' (Inter 12px, #e2e8f0). Right: cloud-download icon. 48px vertical padding. This is the only dark band on the page outside the CTA button.

### Primary Filled CTA Button
**Role:** Main conversion action (e.g. 'Join Peggy')

#141414 background, #ffffff text, Inter 14px weight 500, 0px border-radius (sharp rectangle), 16px horizontal x ~12px vertical padding, single line, no icon. Sits as a deliberate weight-anchor against the white field - the only black rectangle in the interface.
...
Below the link columns, 1px top border #f4f4f4, 24px vertical padding. Left: '(C) Peggy . {year}' in Monument Grotesk 12px #666666. Right: social icon cluster (Facebook, Instagram, X) in 20px solid #000000 squares with no radius.

...
### Sohne Ikon - Iconographic variant of Sohne for interface glyphs, special characters, and numeric UI elements. Same voice as Sohne but with alternate character forms via calt and tabular figures via tnum. - `--font-shne-ikon`
- **Substitute:** Sohne (Klim's own)
- **Weights:** 400
- **Sizes:** 
- **Line height:** 1.20, 1.33, 1.50
- **OpenType features:** `"tnum" on, "calt" on`
- **Role:** Iconographic variant of Sohne for interface glyphs, special characters, and numeric UI elements. Same voice as Sohne but with alternate character forms via calt and tabular figures via tnum.
...
:root {
 ...
 --font-shne-ikon: 'Sohne Ikon', ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;

...
- **Substitute:** Sohne, Inter, or GT America - all humanist sans-serifs with similar x-height and warmth
- **Weights:** 400, 500
...
Transparent background, 1px Warm Parchment (#ffebd0) border, 8px radius, 16-18px horizontal padding, 6-8px vertical padding. Text in ModernEra 400 at 16px in Warm Parchment. The 'Portef lje' button in the header is the canonical example. No fill state - outlined only.
...
Fixed or absolute over hero imagery. Logo 'ASPELIN REITAN' top-left at 16-18px ModernEra 500 in Warm Parchment, letter-spaced wide enough to read as a wordmark. Navigation items top-right: an outlined 'Portef lje' button (8px radius) and a 'Meny' text label. No background fill - the header is transparent over the hero photograph.
...
- **Sn hetta** - Same warm cream backgrounds, full-bleed architectural photography, and restrained editorial typography - both treat the website as a portfolio of built work rather than a product

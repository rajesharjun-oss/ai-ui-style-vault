...
- **Substitute:** Sohne (Klim Type Foundry) or Inter as a free alternative - both share the same humanist-geometric balance and tight tracking behavior
- **Weights:** 300, 400
...
- **Sn hetta (snohetta.com)** - Shared Scandinavian agency restraint - left-aligned typographic columns, hairline dividers, and project showcases that let oversized photography dominate without competing UI

...
- **Substitute:** Inter, DM Sans, Sohne
- **Weights:** 400
- **Sizes:** 12, 14
- **Line height:** 1.20
- **Letter spacing:** normal
...
Transparent fill, #10100f 1px border, #10100f text, 9999px border-radius, same 12x32 padding as filled. Shares identical geometry - only fill distinguishes primary from secondary.

...
A 100vw x full-height band filled with #191919, no border, no radius, no shadow. Image or video content fills the band edge-to-edge. The transition from white to this band is abrupt - no gradient, no fade. Acts as a visual exhale between white pages.

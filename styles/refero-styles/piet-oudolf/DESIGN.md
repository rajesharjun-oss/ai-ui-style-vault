...
- **Lars Muller Publishers** - Same museum-colophon mood - Univers-style sans, generous leading, hairline rules instead of borders, and content that behaves like a printed index rather than a software interface

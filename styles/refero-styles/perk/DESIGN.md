...
Background #beff50, text #14140f, radius 28px, padding 16px top/bottom x 16px left x 12px right. Weight 500, 16px OTSono. This is the only filled button in the system - the electric lime against off-white is the singular action signal.

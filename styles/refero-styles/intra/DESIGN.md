...
1px #000000 border, 0px radius, 6px horizontal x 1px vertical padding, color #000000, text 16-20px Whyte weight 400. The minimal vertical padding (1px) creates a very thin, type-like bar - this button reads as underlined text with a stroke, not a conventional pill. Used for "BUY IN-STORE" and similar nav-style actions.

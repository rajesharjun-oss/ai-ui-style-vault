...
Transparent or #ffffff fill, 1px #0a0a0a or #ffffff border, 5px radius, 20px vertical x 20px horizontal padding, 11-12px Soehne weight 500 uppercase at +0.15em tracking. Text color matches border color (reversible on dark sections).

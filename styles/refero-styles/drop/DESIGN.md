...
- **Substitute:** Inter, Sohne, or General Sans
- **Weights:** 300, 400, 500
...
Obsidian (#101010) fill, white text, ABC Normal 16px weight 400, 1440px radius (full pill), 14px vertical x 18px horizontal padding. No shadow. Optional small arrow icon after label in 12-14px. The absence of a chromatic CTA color makes this near-black button the unmistakable action - restrained but commanding.

### Ghost Pill Button
**Role:** Secondary action with no fill

Transparent background, 1px Obsidian border, Obsidian text, 1440px radius, 12-14px vertical x 18px horizontal padding. Used for 'Login' and secondary CTAs in the nav.
...
Lavender Mist or Electric Yellow background, Obsidian text, 1440px radius, 8-12px vertical x 14-20px horizontal padding, ABC Normal 11-12px weight 500, uppercase, letter-spacing slightly positive. Functions as a section marker ('THE OLD WORLD' / 'THE NEW WORLD').
...
2. **Create a section pill badge**: 1440px radius, #b8afda background, #101010 text, ABC Normal 12px weight 500 uppercase, 8px vertical x 16px horizontal padding. Label: 'THE NEW WORLD'.

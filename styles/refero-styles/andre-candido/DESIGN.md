...
Ink Black (#111118) fill, Paper White (#ffffff) text, PP Mori 14-15px weight 600, letter-spacing 0.107em, uppercase tracking. 24px border-radius, 16px horizontal x 10px vertical padding. 1px Ink Black border for definition.

### Ghost Pill Button
**Role:** Secondary action on light backgrounds

Transparent fill, 1px Ink Black (#111118) border, Ink Black text. 24px border-radius, 16px x 10px padding. Used for the 'Start a project' and 'About me' actions.

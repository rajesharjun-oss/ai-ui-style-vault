...
> Art Deco gallery catalogue - burnished gold hairlines on bone-white vellum
...
- **Hermes** - Same restraint of a single chromatic accent (Hermes orange) against a warm off-white canvas, hairline rules, and serif-first typography with no shadows or rounded corners
- **Aedes East Hampton** - Same Art Deco / gallery-catalog sensibility - large illustrated plates, italic serif section titles with thin underlines, three-column product grids divided by hairline rules

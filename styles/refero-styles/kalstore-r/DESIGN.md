...
- **Substitute:** Inter, Neue Haas Grotesk, or Sohne
- **Weights:** 400, 500
...
Mustard (#f1ba35) background, Ink (#242424) text, ABCDiatype weight 500 at 14px, 8px corner radius, 6px horizontal x 8px vertical padding, 1px Ink border for definition. Compact, almost link-sized - this button whispers rather than shouts, relying on the yellow hue to draw the eye.
...
Dark surface (Espresso #30250b or near-black), Pure White (#ffffff) text, Mustard (#f1ba35) CTA button. ABCDiatype 19px headline, 14px body, 12px fine print. 8px input radius with 1px Felt Gray border. Fixed bottom-right with close (x) in the top-right corner. This is the most visually dense component - it's the only place dark surfaces and colored buttons coexist.

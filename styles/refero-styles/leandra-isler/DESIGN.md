...
- **Substitute:** Sohne (Klim Type Foundry) - closest geometric-grotesk cousin with identical warmth and identical 400/500 weights. Free fallback: Inter at the same weights.
- **Weights:** 400, 500
...
- **Studio Daidai** - Same single-typeface system stretched from caption to display on a warm neutral background, with real plant photography as the only non-neutral element

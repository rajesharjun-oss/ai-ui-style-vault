...
Photograph fills 100vw x 100vh with no overlay, no darkening, no gradient. All UI elements float on top: navigation, display headline, description, scroll indicator. The image is the brand - no decorative gradient or vignette is added.

...
#070707 background, 9.3px border-radius, no shadow. Contains a full-bleed image or typographic spread (e.g. a large white serif ' ' or a magazine cover). Padding is internal to the media; the card itself is flush. Width adapts to a 2-column or 3-column grid.

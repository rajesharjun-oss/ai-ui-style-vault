...
- **Substitute:** Inter (closest free alternative), then Sohne or General Sans
- **Weights:** 400, 500
...
Pill shape (~999px radius), white fill, 1px Cool Hairline border, 12-16px padding. Placeholder 'Enter your message' in 14px Carbon Gray. Optional icon buttons (up-arrow submit, mic) at right edge, 32x32 hit targets.

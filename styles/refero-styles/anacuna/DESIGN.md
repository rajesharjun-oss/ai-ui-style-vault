...
Full-width row, 1px #000000 top border, #ffffff background. Left: 'ANA CUNA ILUSTRACION (C) 2026' at 15px. Right: 'LEGAL | COOKIES' at 15px. The vertical pipe separator carries the only inline typographic glyph in the system besides the pill text.

...
- **Substitute:** Inter, Sohne, ABC Diatype
- **Weights:** 400
- **Sizes:** 17, 22
...
Top border 1px solid #121212, 30-40px vertical padding, three-column grid: logo wordmark left, '(C) Seoul, Korea' right, monospace tag center. #121212 text on white.
...
- **Studio Daidai** - Same monochrome neo-grotesque + monospace label pairing with oversized display headlines and generous editorial spacing

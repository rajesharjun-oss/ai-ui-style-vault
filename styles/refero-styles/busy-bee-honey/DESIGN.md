...
1000px border-radius pill, Dark Cocoa (#3b2722) fill, Cream Parchment (#f2ebd0) Arial 13px all-caps text with 0.24px tracking, 16px vertical x 24px horizontal padding. Optional right-arrow icon in 14px. The dark-on-light inversion is reserved for the gold band.

...
Build an original Product Details UI inspired by this Refero web page screenshot set reference for Aesop.

Use these signals:

- Channel: web
- Entity type: website
- Entity description: Formulations for Skin, Hair & Body
- Palette: screen-color-1 #22211f, screen-color-2 #5e442f, screen-color-3 #87581d, screen-color-4 #9f9c92, screen-color-5 #fbfbf3
- Page elements: List, Button, Checkbox & Radio, Page Control & Pagination, Navigation Bar, Footer, Photo, Icon, Illustration, Currency
- Design patterns: Shopping
- Fonts observed: Suisse

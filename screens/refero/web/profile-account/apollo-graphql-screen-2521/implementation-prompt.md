...
Build an original Profile & Account UI inspired by this Refero web page screenshot set reference for Apollo GraphQL.

Use these signals:

- Channel: web
- Entity type: website
- Entity description: The supergraph: a new layer in your stack
- Palette: No palette extracted.
- Page elements: Button, Tabs, Badge, Navigation Bar, Icon, Illustration, Avatar
- Design patterns: Empty State
- Fonts observed: Source Sans Pro
